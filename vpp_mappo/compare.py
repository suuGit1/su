...
def compare(checkpoint, output, csv_path=None, episodes=3, seed=100000, lookahead=6):
    out=Path(output)
    ...
    learned=evaluate(checkpoint,out/'learned',episodes,seed,'cpu',csv_path)
...
def main():
    ...
    a=p.parse_args(); compare(a.checkpoint,a.output,a.csv,a.episodes,a.seed,a.lookahead)
