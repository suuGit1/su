...
class ResearchEnv(CyberVPPAdapter):
    def __init__(self,config,csv_path=None,dt_model=None,robust=False,vector_metrics=True,ac_safe=False):
    ...
    def sensor_payloads(self):
        ...
        data[2]['carbon_g_per_kwh']=r.get('carbon_g_per_kwh',self.config.synthetic_carbon_g_per_kwh or 0.)
        return data
    ...
    def step_candidate(self,energy,bw,cpu):
        ...
        if self.vector_metrics:
            ...
            info.update(objective_version=OBJECTIVE_VERSION,objective_vector=vector.tolist(),carbon_kg=kg,
